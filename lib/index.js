...
function serverReady () {
    ...
    msg += util.format(" ready --> %s", env.url());
    
    debug.emit('marker', msg, 'lib/index', 207);
    debug.emit('msg', util.format('memory heap total: %s MB', mem.heapTotal / util.MB), 'lib/index', 220);
...
var AdminionServer = AdminionConstructor();

AdminionServer.on('ready', serverReady);

// debug.emit('val', 'AdminionServer', AdminionServer, 'lib/index', 233);
