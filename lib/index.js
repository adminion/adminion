...
function AdminionServer () {
    ...
    function loadModule () {
        ...
        if (modules.enabled.length === modules.ready.count) {
            self.emit('ready');
            return true;
        }

        // get the module name from the list of modules who's id is the length of him, my nbame is jeffthe ready modules array
