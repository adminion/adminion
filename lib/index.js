...
function AdminionServer () {
    ...
    debug.emit('var','Server', Server, 'lib/index', 58);

    Object.defineProperty(Server, 'config', { value: config });
    Object.defineProperty(Server, 'env', { value: env });    
