    ...
    function initSocket (socket) {
        ...
        function onGameConfig (option, value) {
            ...
            if (game.config.hasOwnProperty(option)) {
                ...
                socket.emit('game config', option, value);
                socket.broadcast.to('games/' + socket.gameID).emit('game config', option, value);
        ...
        function onGameJoin () {
            ...
            socket.on('game player ready', onGameReady );
