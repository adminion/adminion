...
module.exports = function (tools) {
    ...
    app.get('/', function (request, response) {
        ...
        debug.emit('var' , 'request.session', request.session);
    ...
    app.get('/accounts/:email', verify, function (request, response) {
        debug.emit('var' , 'request.account', request.account);
    ...
    http.listen = function () {
        ...
        http.server.listen(tools.config.port, function serverListerning () { 
