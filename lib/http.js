...
module.exports = function Http (Adminion) {

	Adminion.http = Object.create(events.EventEmitter.prototype);

	Adminion.http.cookieParser = express.cookieParser;

	Adminion.http.init = function (onReady) {
		app = express();
		...
		app.configure(function () { 
			...
			Adminion.http.mongoStore = new connectMongo({ mongoose_connection: Adminion.db.connection});
